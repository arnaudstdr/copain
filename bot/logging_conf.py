...
def configure_logging(
    ...
    # Mute les loggers ChromaDB (télémétrie désactivée, anonymized_telemetry=False).
    # Le logger interne a changé en 1.x (réécriture Rust) ; on mute
    # les anciens et nouveaux noms par précaution.
    for _name in ("chromadb.telemetry.product.posthog", "chromadb.telemetry"):
